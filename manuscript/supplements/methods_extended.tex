...
Values in main-text Table~2 (validation cohort) are from seed 42;
mean $\pm$ SD across the five seeds is in Supplementary Table~S7.
...
1.07--4.05 (see main-text Table~3; mean 1.97, every value
